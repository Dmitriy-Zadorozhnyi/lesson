...
/*
Слушатель (listener) из примера ниже будет мониторить выполнение теста
и как только определенный метод/класс теста будет выполнен,
он отправит имя, продолжительность и кое-какие дополнительные детали.

Примечание: Используйте дополнительный тег, отвечающий вашим задачам в приведенном ниже примере,
чтобы классифицировать результаты. Например tag(“scenario”, “login flow”).
 */
